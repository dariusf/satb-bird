...
/**
*/
export const Kind = Object.freeze({ Y:0,"0":"Y",M:1,"1":"M",A:2,"2":"A", });
/**
*/
export class WasmPitchDetector {
    ...
    */
    static new(which, sample_rate, fft_size) {
        const ret = wasm.wasmpitchdetector_new(which, sample_rate, fft_size);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('pitch_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
